<?php
// src/Api/variedades/ApiValidarNombreVariedad.php
...
try {
    ...
    $sql = "SELECT IdVariedad FROM GEN_Variedades 
            WHERE UPPER(NOMVARIEDAD) = UPPER('$nombre') 
            AND IdProducto = $idProducto";
    
    if ($idExcluir > 0) {
        $sql .= " AND IdVariedad != $idExcluir";
    }

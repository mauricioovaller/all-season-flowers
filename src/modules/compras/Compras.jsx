...
export default function Compras() {
    ...
    return (
        <div className="space-y-4 md:space-y-6 px-2 md:px-0">
            {/* Barra de acciones COMPACTA - IGUAL A PEDIDOS */}
            <div className="bg-white rounded-lg md:rounded-xl shadow-sm md:shadow-md p-3 md:p-4">
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-3 gap-2">
                    <div className="flex items-center justify-between">
                        <div>
                            <h2 className="text-lg md:text-xl font-semibold text-slate-700">Compras - All Season</h2>
                            <p className="text-xs md:text-sm text-gray-600 mt-0.5">Sistema de compras</p>
                        </div>
                        <button
                    ...
                    <div className="text-right">
                        <div className="text-xs md:text-sm font-medium text-gray-700">
                            Estado: <span className={`font-bold ${header.noCompra !== 'COMP-000000' ? 'text-green-600' : 'text-orange-600'}`}>
                ...
                {/* Botones - Responsivos - IGUAL A PEDIDOS PERO CON ORDEN DE COMPRA */}
                <div className={`${menuCompacto ? 'hidden md:flex' : 'flex'} flex-col sm:flex-row gap-2`}>
                        ...
                        <div className="flex items-center justify-center gap-1">
                            {guardando ? (
                                ...
                                <>
                                    ...
                                    <span>{header.noCompra !== "COMP-000000" ? "Actualizar" : "Guardar"}</span>
                                </>
                            )}
                        </div>
                    </button>
                    ...
                    <button
                        ...
                        className={`rounded-lg px-3 py-2 transition font-medium text-sm flex-1 ${header.noCompra !== "COMP-000000"

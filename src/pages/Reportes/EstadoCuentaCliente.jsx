                                ...
                                <table className="w-full text-xs">
                                    <thead className="bg-gray-50 text-gray-600 uppercase text-xs">
                                        <tr>
                                            ...
                                            <th className="px-3 py-3 text-right whitespace-nowrap">Valor Invoice</th>
                            ...
                            <div className="block md:hidden divide-y divide-gray-100">
                                ...
                                {totales && (
                                    <div className="bg-green-700 text-white p-4">
                                        ...
                                        <div className="space-y-2">
                                            <div className="flex justify-between items-end">
                                                <span className="text-xs text-green-200">Valor</span>
                                                <div className="text-right">
                                                    <div className="text-sm font-medium">{formatNum(totales.valorBase)}</div>
                                                    <div className="text-xs text-green-200">{formatNum(totales.valorBaseCOP)} COP</div>
                                                </div>
                                            </div>
                                            <div className="flex justify-between items-end">
                                                <span className="text-xs text-green-200">Devolución</span>
                                                <div className="text-right">
                                                    <div className="text-sm font-medium">{formatNum(totales.valorDevolucion)}</div>
                                                    <div className="text-xs text-green-200">{formatNum(totales.valorDevolucionCOP)} COP</div>
                                                </div>
                                            </div>
                                            <div className="flex justify-between items-end">
                                                <span className="text-xs text-green-200">Pagado</span>
                                                <div className="text-right">
                                                    <div className="text-sm font-medium">{formatNum(totales.valorPagado)}</div>
                                                    <div className="text-xs text-green-200">{formatNum(totales.valorPagadoCOP)} COP</div>
                                                </div>
                                            </div>
                                            <div className="flex justify-between items-end border-t border-green-500 pt-2">
                                                ...
                                                <div className="text-right">
                                                    ...
                                                    <div className="text-xs text-green-200 font-semibold">{formatNum(totales.saldoCOP)} COP</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
